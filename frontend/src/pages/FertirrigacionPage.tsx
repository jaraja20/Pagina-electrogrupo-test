...
const IMG = {
  ...
  cardComposition: PLACEHOLDER("Composicion+liquida"),
  cardTechnology: PLACEHOLDER("Tecnologia+americana"),
  cardPivot: PLACEHOLDER("Fertirrigacion+pivot"),
  cardProductivity: PLACEHOLDER("Records+productividad"),
...
const INTRO_CARDS = [
  {
    ...
    desc: "Los tres ritmos de nitrógeno en una sola aplicación.",
    image: IMG.cardComposition,
    target: "composicion",
  },
  {
    title: "Tecnología de formulación americana",
    desc: "Probada para calor, humedad y suelos tropicales.",
    image: IMG.cardTechnology,
    target: "tecnologia",
  },
  {
    title: "Compatible con fertirrigación por pivot central",
    desc: "Aplicá OuroPro directamente con tu pivote Western.",
    image: IMG.cardPivot,
    target: "pivot",
  },
  {
    title: "Récords de productividad por hectárea",
    desc: "Mejora real de rendimiento con fertirrigación precisa.",
    image: IMG.cardProductivity,
    target: "productividad",
  },
  {
    title: "Soporte técnico real",
    desc: "Técnicos especializados en fertirrigación y pivot.",
