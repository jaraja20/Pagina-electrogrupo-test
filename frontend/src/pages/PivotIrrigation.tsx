...
const IMG = {
  ...
  wideControl: "https://customer-assets.emergentagent.com/job_empresa-solutions-2/artifacts/axezn9ct_Photo_Icontec_Ls4x4d_Staff-1.webp",
  wideRobustness: "https://customer-assets.emergentagent.com/job_empresa-solutions-2/artifacts/iox45ekp_Photo_Wes_Pivots-1%20%281%29.webp",
...
// --- Hero KSPs ---
const HERO_KSPS: { icon: LucideIcon; title: string; text: string }[] = [
  { icon: Droplets, title: "Sistema de riego adaptado a tu campo", text: "Solución que se ajusta a tus necesidades." },
  { icon: Wifi, title: "Control remoto en tiempo real", text: "Monitoreo y gestión a distancia." },
  { icon: Gauge, title: "Distribución eficiente de agua", text: "Optimización del uso del recurso hídrico." },
];

// --- Intro dark cards: "Western, hecho para el campo paraguayo" ---
const WESTERN_CARDS = [
  {
  ...
  },
  {
    ...
    desc: "No importa el terreno. El sistema se ajusta para que vos no pierdas productividad.",
    image: IMG.cardAdaptation,
  },
  {
    title: "Paneles de control avanzados",
    desc: "Datos en tiempo real. Decisiones más rápidas, menos errores.",
...
const SECTIONS: SectionData[] = [
  ...
  },
  {
    ...
    imageAlt: "Productora controlando el sistema iControl desde una tablet al atardecer",
    benefits: [
  ...
  },
  {
    ...
    imageAlt: "Torre Western mostrando su estructura de acero galvanizado sobre un campo de trigo",
    benefits: [
  ...
  },
  {
    id: "soporte",
    eyebrow: "Respaldo",
    title: "El respaldo no se promete. Se demuestra.",
  ...
  <section className="relative min-h-[95vh] flex items-center pt-24 overflow-hidden bg-[#0D1B2A]">
    ...
    <div className="container mx-auto px-6 md:px-8 relative z-10 py-20">
      <motion.div
        ...
        className="max-w-5xl"
      >
        <Badge className="bg-white/90 text-[#0D1B2A] hover:bg-white mb-6 px-4 py-1 text-xs font-bold uppercase tracking-[0.2em] rounded-md">
          Western
        </Badge>
        <h1
        ...
        >
          Riego por Pivot Central Western<br className="hidden md:block" /> en Paraguay
        </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 mb-14 max-w-4xl">
          {HERO_KSPS.map((ksp, idx) => {
            ...
            return (
              ...
              >
                <Icon className="w-7 h-7 text-[#E31E24]" strokeWidth={1.75} />
                <h3 className="text-white font-semibold text-base md:text-lg leading-tight">{ksp.title}</h3>
        ...
        >
          <a href="https://wa.me/595983130313" target="_blank" rel="noopener noreferrer" data-testid="hero-cta-primary">
...
// --- Intro Dark Section: "Western, hecho para el campo paraguayo" ---
const WesternIntro = () => (
    ...
    <div className="container mx-auto px-6 md:px-8">
      ...
      >
        ...
        <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white font-heading leading-[1.1] mb-6 tracking-tight">
          Diseñado para producir más,<br className="hidden md:block" /> no para regar igual.
        </h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
        {WESTERN_CARDS.map((card, idx) => (
          <motion.article
            ...
            className="relative rounded-3xl overflow-hidden aspect-[4/5] md:aspect-[3/4] group cursor-default shadow-xl"
          ...
          >
            ...
            <div className="absolute inset-0 flex flex-col justify-end p-7 md:p-8 text-white">
              <h3 className="text-xl md:text-2xl font-bold mb-3 leading-snug font-heading">
                {card.title}
              </h3>
      ...
      <div className="container mx-auto px-6 md:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 mb-14 md:mb-20">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-[#0D1B2A] font-heading leading-[1.08] tracking-tight">
              {data.title}
            </h2>
          </motion.div>
          <motion.div
        ...
        <motion.div
          ...
          className="mb-10"
        >
          <span className="text-[#0D1B2A] text-xs font-bold uppercase tracking-[0.25em] border-t border-gray-300 pt-5 block">
            Beneficios
          </span>
        </motion.div>
    ...
    <div className="container mx-auto px-6 md:px-8 relative z-10">
      ...
      >
        ...
        <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold font-heading leading-[1.05] mb-8 tracking-tight">
          El clima no es una variable.<br className="hidden md:block" /> Es un riesgo que podés eliminar.
        </h2>
        ...
        <a href="https://wa.me/595983130313" target="_blank" rel="noopener noreferrer" data-testid="cta-final-btn">
          <Button
            size="lg"
  ...
  return (
    <>
      <Helmet>
        ...
        />
        <meta name="keywords" content="riego por pivot, pivot central, Western, iControl, irrigación Paraguay, Electrogrupo, agricultura, eficiencia hídrica" />
      </Helmet>
